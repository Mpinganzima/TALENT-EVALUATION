...
public class AuthorizationFilter implements Filter, WebConstants {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		try {
			...
			if ((reqURI.indexOf("signup.xhtml") >= 0 || reqURI.indexOf("login.xhtml") >= 0
					|| reqURI.indexOf("homepage.xhtml") >= 0 
